 ...
 include("../functions/phpfunctions.php");
  ...
  ?>
      ...
      <div class="limiter">
		...
		$conexion = con();
		$sql1="SELECT idAcc,FolioAccidente,FolioAccidentado,expediente  FROM vasegurobd.tb_accidentes WHERE  idAcc = ".$idAcc."  LIMIT 0,1;";
...
<div><input  name="foAcc" id="foAcc" style="border:none;" value="<?php echo $mostrar['FolioAccidente']?>" readonly></div>
              <div class="col-3" >
  ...
  echo $fechaActual;
      ...
      <input  name="ex" id="ex"  value="<?php echo $mostrar['expediente']?>" readonly>
...
<div class="col-2" >
<label>SELECCIONE UN ESTADO PARA LA SOLICITUD:
<select id="estatusSolicitud" name="estatusSolicitud"  required>
<option><?php echo  $mostrar['estadoSolicitud'] ?> </option>
<option>APROBADA</option>
<option>APROBADA PARCIALMENTE</option>
<option>RECHAZADA</option>
<option>SE NECESITA MAS INFORMACION</option>
...
<label>
ESCRIBA UN COMENTARIO ACLARATORIO PARA RESPONDER LA SOLICITUD(OPCIONAL):
<input id="cometarioMed" name="comentarioMed" type="text" placeholder="COMETARIO DEL MEDICO REVISOR" value="<?php echo  $mostrar['comentarioMed'] ?>">
...
<option><?php echo  $mostrar['autorizacion'] ?></option>
<option>INICIAL</option>
<option>COMPLEMENTO</option>
<option>INICIAL ALTA</option>
<option>COMPLEMENTO ALTA</option>
<option>INICIAL PREALTA</option>
<option>COMPLEMENTO PREALTA</option>
...
<div class="col-2" >
<label>SUBSENCUENCIA:
<select id="subse" name="subse">
<option><?php echo  $mostrar['subsecuencia'] ?> </option>
<option>SUBSECUENTE 1</option>
<option>SUBSECUENTE 2</option>
<option>SUBSECUENTE 3</option>
<option>SUBSECUENTE 4</option>
<option>SUBSECUENTE 5</option>
<option>SUBSECUENTE 6</option>
<option>SUBSECUENTE 7</option>
<option>SUBSECUENTE 8</option>
<option>SUBSECUENTE 9</option>
<option>SUBSECUENTE 10</option>
</select>
...
<?php 
  ...
  <div class="col-1"> <span class="textSection"><center>AGREGAR ARCHIVOS</center></span>  </div>
  <?php archivosPorTipoSA(); ?>
  
 
    <div class="col-1" style="border: solid black;" id="mensajesBox"><?php chatMed($idSA, "M"); ?></div>
