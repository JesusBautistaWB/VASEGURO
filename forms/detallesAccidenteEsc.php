...
<body>
   ...
   include("../functions/phpfunctions.php");
    ...
    dirEscRepor,notasAcc, regionPrincipal, dialectoAcc, dialectoAccES, indigenaAcc, curpAcc
...
var palabra = $('#foAcc').val();
 ...
 <div class="col-1"> <span class="textSectionRED"><center>DIAGNOSTICOS ASOCIADOS AL ACCIDENTE</center></span>
  ...
  <table id="procetab"></table>
         ...
         <div class="col-1">   
        <center><a href="pdfdet.php?idAcc=<?php
         echo $mostrar['idAcc']; 
         ?>"><button type="button" class="submitbtn" onclick="" style="width:200px;">OBTENER PDF</button> </a></center>
             <label><br></label>
          </div> 
