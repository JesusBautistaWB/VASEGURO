...
<div class="header">
 ...
 include("../functions/phpfunctions.php");
  ...
  ?>
      ...
      <form id="arrHosForm" action ="../functions/confirmarCambio.php" method="POST" enctype="multipart/form-data">   
      <div class="col-2">
          <label>
          ...
          <div class="col-1"><label><br></label></div>
            ...
            <select id='tipoDocumento' name='tipoDocumento'>
              ...
              <option>OTRO</option>
               ...
               <span  style='font-size: 15px; block: inline;'><a href='".$mostrar['ruta']."'>".
