...
<body>
   ...
   include("../functions/phpfunctions.php");
    ...
    ?>
      ...
      <form  action ="../functions/insertarSERAD.php" method="post" style=" gray; border-width: 1px; border-style: solid;"> 
      <div  class="col-3" >
          <label>
  ...
  echo $fechaActual;
    ...
    FechaNacimientoA,GradoEscolarA, estado, apRes, amRes, nombreRes, telFiRes, telCelRes, periodoDeCobertura, tipoDeEventoInicial, tipoLlamada,
