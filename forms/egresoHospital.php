...
<div class="header">
 ...
 include("../functions/phpfunctions.php");
  ...
  $.ajax({
    ...
    <?php archivosPorTipo(); ?>
    <div class="col-1"> <span class="textSection">-</span> </div>  
    <div class="col-2">
    
<label>HOJA ENCUESTA:

</label>  <center><input id="hojaencuesta" name="hojaencuesta[]" type="file" multiple>
    </center>
...
<label>FECHA EGRESO:
  <input id="fechaEgreso" name="fechaEgreso" type="date" value="<?php echo date('Y-m-d'); ?>" required>
    
   
</label>
    </div>
    <div class="col-1"><label><br></label></div>
    <div class="col-1"> <span class="textSectionRED">-</span> </div>  
        <?php
         diagnosticosEgreso();
