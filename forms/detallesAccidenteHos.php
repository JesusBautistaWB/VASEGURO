...
<body>
    ...
    <center>         
       <?php 
        ...
        <span class='titleHeader'>   AVISO DE ACCIDENTE | DETALLES </span>";
...
var palabra = $('#foAcc').val();
  ...
  $.ajax({
    ...
    success:function(data){
      ...
      <div class="col-3"><span class="accdetRED"><?php echo "<b> Donde ocurrio el accidente:</b><br> ".$mostrar['lugarAccIn'].", ".$mostrar['idLugarAccidente']; ?></span></div> 

<div class="col-1"><span class="accdetRED"><?php echo "<br><b> DESCRIPCION DE ACCIDENTE: </b><br></span><label>".$mostrar['descRepor']."</label>"; ?></div>
...
<div class="col-1" style="display: none">
       ...
       <div class="col-3"><span class="accdet"><?php  echo "<br><b> CURP:</b></br>  ".$mostrar['curpAcc']; ?></span></div>
       <div class="col-3"><span class="accdet"><?php  echo "<br> <b>PERSONA ACCIDENTADA:</b> <br> ".$mostrar['PrimerApellidoA']." ".$mostrar['SegundoApellidoA']." ".$mostrar['NombreA']; ?></span></div> 
         <div class="col-3"><span class="accdet"><?php  echo "<br><b> GRADO ESCOLAR:</b> <br> ".$mostrar['GradoEscolarA']; ?></span></div>
          ...
          <div class="col-1"><span class="accdetRED"><?php  echo "<b><br>NOTAS AGREGADAS AL ACCIDENTE: <br> </b><label>".$mostrar['notasAcc']."<br><br></label>"; ?></span></div>
