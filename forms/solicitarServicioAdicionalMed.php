...
<body>
   ...
   include("../functions/phpfunctions.php");
    ...
    ?>
      ...
      <span class="login100-form-title">SOLICITAR</span>     
   </center>
      ...
      <form  action ="../functions/insertarSERADMED.php" method="post" enctype="multipart/form-data"> 
      <div  class="col-3" >
          <label>
     ...
     AND idAcc = ".$idAcc." AND ACCT.idEscuela=ESC.idEscuela AND ES.idEstatus=ACCT.idEstatus AND ACCT.FolioAccidentado=ACT.FolioAccidentado LIMIT 0,1;";
		...
		while($mostrar=mysqli_fetch_array($result)){
		 ?>
               ...
               <div class="col-1"><label><input type="hidden" id="idAcc" name="idAcc" value="<?php echo $mostrar['idAcc'];  ?>" > </label>
               
               <input   name="idSA" id="idSA" style="border:none; display: none;" value="<?php echo $idSA; ?>"  readonly> 
              </div>
