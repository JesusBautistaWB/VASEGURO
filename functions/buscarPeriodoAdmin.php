...
<tr>
    ...
    <td>LUGAR DONDE OCURRIO EL ACCIDENTE</td>
    ...
    <td>TIEMPO GENERANDO SINIESTRO(Minutos)</td>
		...
		<tr >
        <td><a href="eliminarAccidente.php?foAcc=<?php echo $mostrar['FolioAccidente']."&&usu=".$usu; ?>"  onclick="return confirm('Este proceso ELIMINA el registro del accidente, asi como directorios y datos asociados como procedimientos, lesiones y diagnosticos. ¿Desea continuar? ')" ><img src='../images/delete.png' height='20'  width='20' ></a></td>
