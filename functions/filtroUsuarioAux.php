  ...
  ?>
	<tr >
            ...
            OR $mostrar['idEstatus'] == "13" OR $mostrar['idEstatus'] == "6"  OR $mostrar['idEstatus'] == "7"  ){
               echo "<a href='detallesAccidenteMedAux.php?idAcc=".$mostrar['idAcc']."' method= 'GET'>".$mostrar['FolioAccidente']."</a>";
            }  
            
            if ($mostrar['idEstatus'] == "4" OR $mostrar['idEstatus'] == "12"){
               echo "<a href='detallesAccidenteMedAux.php?idAcc=".$mostrar['idAcc']."' method= 'POST'>".$mostrar['FolioAccidente']."</a>";
            }  
            if ( $mostrar['idEstatus'] == "2" ){
                echo "<a href='detallesAccidenteMedAux.php?idAcc=".$mostrar['idAcc']."' method= 'POST'>".$mostrar['idAcc']."</a>";
             }  



            if ($mostrar['idEstatus'] == "1" ){
               echo "<a href='' method= 'POST'>".$mostrar['idAcc']."</a>";
            }
             if ($mostrar['idEstatus'] == "9" ){
               echo "<a href='' method= 'GET'>".$mostrar['FolioAccidente']."</a>";
            }
