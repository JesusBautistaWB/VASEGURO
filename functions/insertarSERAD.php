...
VALUES('$sa1', '$foAcc', '$msa1','NUEVO','$hospital','$coa1','$fechaSolicitud')";
...
VALUES('CIRUJANO', '$foAcc', '$ciru','NUEVO','$hospital','$ciruN','$fechaSolicitud','$idHos')";
...
(conceptoServicio, folioAccidenteServicio, costoServicio, estadoSolicitud,
hospitalOrigen, comentarioAcc, fechaSolicitud, idHos)
VALUES('ANESTESIOLOGO', '$foAcc', '$anes','NUEVO','$hospital','$anesN','$fechaSolicitud','$idHos')";
...
(conceptoServicio, folioAccidenteServicio, costoServicio, estadoSolicitud,
hospitalOrigen, comentarioAcc, fechaSolicitud, idHos) 
VALUES('AYUDANTE', '$foAcc', '$ayud','NUEVO','$hospital','$ayudN','$fechaSolicitud','$idHos')";
...
(conceptoServicio, folioAccidenteServicio, costoServicio, estadoSolicitud,
hospitalOrigen, comentarioAcc, fechaSolicitud, idHos)
VALUES('AYUDANTE', '$foAcc', '$ayud2','NUEVO',hospital','$ayudN2','$fechaSolicitud','$idHos')";
...
(conceptoServicio, folioAccidenteServicio, costoServicio, estadoSolicitud,
hospitalOrigen, comentarioAcc, fechaSolicitud, idHos)
VALUES('CONSULTA', '$foAcc', '$consul','NUEVO','$hospital','$consulDet','$fechaSolicitud','$idHos')";
...
(conceptoServicio, folioAccidenteServicio, costoServicio, estadoSolicitud,
hospitalOrigen, comentarioAcc, fechaSolicitud, idHos)
VALUES('MEDICAMENTOS', '$foAcc', '$medi','NUEVO','$hospital','$mediEs','$fechaSolicitud','$idHos')";
...
(conceptoServicio, folioAccidenteServicio, costoServicio, estadoSolicitud,
hospitalOrigen, comentarioAcc, fechaSolicitud, idHos)
VALUES('TERAPIA', '$foAcc', '$tera','NUEVO','$hospital','$teraDet','$fechaSolicitud','$idHos')";
...
(conceptoServicio, folioAccidenteServicio, costoServicio, estadoSolicitud,
hospitalOrigen, comentarioAcc, fechaSolicitud, idHos)
VALUES('OTRO', '$foAcc', '$otro','NUEVO','$hospital','$otroDet','$fechaSolicitud','$idHos')";
    ...
    if($tipoArchivo == "jpg" || $tipoArchivo == "jpeg" || $tipoArchivo == "png" || $tipoArchivo == "pneg" || $tipoArchivo == "pdf" || $tipoArchivo == "doc" || $tipoArchivo == "docx"){
      ...
      if(move_uploaded_file($_FILES[$name]["tmp_name"][$i], $archivo)){
        $filestab = "INSERT INTO vasegurobd.tb_rutasarchivos (ruta, usuarioCarga, tipo, estado, folioAcc, idSA, tipoDocumento)
         VALUES ('$archivo','$id','SOLICITUD', 'EN REVISION', '$foAcc','', '$tipo')";
