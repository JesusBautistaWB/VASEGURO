...
$esAu = trim($_REQUEST['esAu']);
$comentarioAcc = $_REQUEST['comentarioAcc'];
...
$especialidadMed = $_REQUEST['especialidad'];
...
$p3c = $_POST['p3'];
      ...
      $sql = "UPDATE vasegurobd.tab_serviciosadicionales SET medicoAt = '$medicoAt',
       domicilioMed = '$domicilioMed', telefonoMed = '$telMed', especialidadMed = '$especialidadMed',
        cedulaMedico = '$cedulaMed', fechaLlenadoDatos = '$fechaMed', comentarioAcc ='$comentarioAcc',
       correoMedico = '$correoMed', observacionesMed = '$observacionesMed', esAu ='$esAu',
        estadoDatos = 'SI',  notasMed = '$notasMed', costoServicio = '$costo', fechaRespuesta = '$fechaID'
...
/*
    ...
    <script>
      ...
      window.location.href = "../forms/adminMedicos.php?foAcc=<?php echo $foAcc; ?>";
      </script>
