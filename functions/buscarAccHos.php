...
if($palabra == ""){
    ...
    $A=" AND ACCT.numHospital = '$palabra' "; 
}
        ...
        GradoEscolarA, regionPrincipal,
         ...
         montosErogadosHM, ACCT.folioSiniestro, dirEscRepor, notasAcc, estatusInterno, envioAcc, indigenaAcc, estadoCivil,
          dialectoAcc, dialectoAccEs, curpAcc, ACCT.correoEscuela, tipollamada, paqueteHosAcc, idTipoDeAccidente, 
          tiempoGenerandoSiniestro, fechaEgreso, paquetePrecio, paquetePrecioIVA
...
<td style = "background-color: #0f1536;" colspan = "52"></td>
...
<tr>
    ...
    <td>TIEMPO GENERANDO SINIESTRO(Minutos)</td>   
    ...
    <?php
		...
		<tr >
        <td><a href="eliminarAccidente.php?foAcc=<?php echo $mostrar['FolioAccidente']."&&usu=".$usu; ?>"  
 ...
 <td class='<?php 
        ...
        <td ><?php echo $mostrar['descRepor'] ?></td>
           ...
           ?></td> 
            ...
            <td class='penrev'><?php echo $mostrar['idHospital'] ?></td>
